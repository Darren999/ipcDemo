package com.example.darrenfan.myaidldemocustomer;
...
import com.example.darrenfan.myaidldemoserver.IMyAidlInterface;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        intent.setAction("com.example.darrenfan.myservice");
        //android 5.0以后直设置action不能启动相应的服务，需要设置packageName或者Component。
        intent.setPackage("com.example.darrenfan.myaidldemoserver"); //packageName 需要和服务端的一致.
